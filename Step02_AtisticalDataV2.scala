...
object Step02_AtisticalDataV2 {
  def main(args: Array[String]): Unit = {
    ...
    /* 测试，数据集只取了1000行 */
    var rateDocument = sc.textFile("file:///home/zeno/Desktop/DaZhong_Comment_DataAnalysis/data/rd_test_data.txt")
 ...
 */
    ...
    val trainDataRdd = rescaledData.select("lable", "features").map { case Row(label: Int, features: Vector) =>
    ...
    /* Test set accuracy = 0.7829224857062518 */
